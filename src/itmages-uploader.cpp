...
void ITmagesUploader::uploadProgress(int action, QString name,
                                     double dt, double dr, double ut, double ur)
{
  Q_UNUSED (dt) Q_UNUSED (dr)
...
void ITmagesUploader::on_lblInfo_linkActivated(const QString &link)
{
  Q_UNUSED (link)
